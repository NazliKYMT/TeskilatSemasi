...
const Node: React.FC<NodeProps> = (props) => {
  const { node, theme, editingNodeId, setEditingNodeId, onUpdateEntity, onAddSecretary, isSearchResult, isCurrentResult, searchResults, currentResultId, onRemoveEntity, isRemoveDisabled } = props;
        ...
        >
          {!isEditing && (
            <button
              ...
              className="absolute top-1 right-1 text-gray-400 hover:text-red-600 disabled:text-gray-300 disabled:cursor-not-allowed transition-colors rounded-full p-1 export-hidden z-20"
              title="Kaldır"
              aria-label="Kaldır"
            >
